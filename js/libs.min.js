    ...
    function () {
        var t = 180 / Math.PI,
            ...
            o = function (t, e, i, s) {
                ...
                e = e || "soft";
                var s, r, a, o, h, l, _, u, p, c, f, m = {}, d = "cubic" === e ? 3 : 2,
                    g = "soft" === e,
                    v = [];
...
function (t) {
    ...
    if (!e.TweenLite) {
        ...
        var I = O._internals = {
            isArray: p,
            isSelector: D
        }, E = O._plugins = {}, N = O._tweenLookup = {}, F = 0,
            L = I.reservedProps = {
                ease: 1,
                delay: 1,
                overwrite: 1,
...
! function (a, b) {
    ...
    d.defaults = {
        ...
        startDefaultBrowserBehavior: function (a, b) {
            b && a && a.style && (d.utils.each(["webkit", "khtml", "moz", "Moz", "ms", "o", ""], function (c) {
                d.utils.each(b, function (b, d) {
                    c && (d = c + d.substring(0, 1).toUpperCase() + d.substring(1)), d in a.style && (a.style[d] = "")
                })
            }), "none" == b.userSelect && (a.onselectstart = null), "none" == b.userDrag && (a.ondragstart = null))
        }
    }, d.Instance = function (a, b) {
        var e = this;
        return c(), this.element = a, this.enabled = !0, this.options = d.utils.extend(d.utils.extend({}, d.defaults), b || {}), this.options.stop_browser_behavior && d.utils.stopDefaultBrowserBehavior(this.element, this.options.stop_browser_behavior), this._eventStartHandler = d.event.onTouch(a, d.EVENT_START, function (a) {
        ...
        on: function (a, b) {
            ...
            return d.utils.each(c, function (a) {
                this.element.addEventListener(a, b, !1), this._eventHandler.push({
                    gesture: a,
                    handler: b
                })
            }, this), this
        ...
        off: function (a, b) {
            ...
            return d.utils.each(c, function (a) {
                ...
                var c = -1;
                d.utils.each(this._eventHandler, function (d, e) {
                    -1 === c && d.gesture === a && d.handler === b && (c = e)
                }, this), c > -1 && this._eventHandler.splice(c, 1)
            }, this), this
        },
        ...
        dispose: function () {
            return this.options.stop_browser_behavior && d.utils.startDefaultBrowserBehavior(this.element, this.options.stop_browser_behavior), d.utils.each(this._eventHandler, function (a) {
                this.element.removeEventListener(a.gesture, a.handler, !1)
            }, this), this._eventHandler.length = 0, d.event.unbindDom(this.element, d.EVENT_TYPES[d.EVENT_START], this._eventStartHandler), this
        }
    };
    var e = null,
        f = !1,
    ...
    d.event = {
        ...
        onTouch: function (a, b, c) {
            ...
            return this.bindDom(a, d.EVENT_TYPES[b], i), i
        },
        ...
        updatePointer: function (a, b) {
            return a == d.EVENT_END ? delete this.pointers[b.pointerId] : (b.identifier = b.pointerId, this.pointers[b.pointerId] = b), Object.keys(this.pointers).length
        },
        ...
        extendEventData: function (a) {
            ...
            var e, f, g = a.timeStamp - b.timeStamp,
                h = a.center.pageX - b.center.pageX,
                i = a.center.pageY - b.center.pageY,
                j = this.current.velocity;
            return c !== !1 && a.timeStamp - c.timeStamp > d.UPDATE_VELOCITY_INTERVAL ? (j = d.utils.getVelocity(a.timeStamp - c.timeStamp, a.center.pageX - c.center.pageX, a.center.pageY - c.center.pageY), this.current.lastVEvent = a, j.x > 0 && j.y > 0 && (this.current.velocity = j)) : this.current.velocity === !1 && (j = d.utils.getVelocity(g, h, i), this.current.velocity = j, this.current.lastVEvent = a), "end" === a.eventType ? (e = this.current.lastEvent && this.current.lastEvent.interimAngle, f = this.current.lastEvent && this.current.lastEvent.interimDirection) : (e = this.current.lastEvent && d.utils.getAngle(this.current.lastEvent.center, a.center), f = this.current.lastEvent && d.utils.getDirection(this.current.lastEvent.center, a.center)), d.utils.extend(a, {
                deltaTime: g,
                deltaX: h,
                deltaY: i,
                velocityX: j.x,
        ...
        handler: function (a, b) {
            if (a.eventType != d.EVENT_MOVE || d.detection.current.reachedTapMaxDistance) {
                if (a.eventType == d.EVENT_END && "touchcancel" != a.srcEvent.type) {
                    var c = d.detection.previous,
                        e = !1;
                    if (d.detection.current.reachedTapMaxDistance || a.deltaTime > b.options.tap_max_touchtime) return;
            ...
            } else d.detection.current.reachedTapMaxDistance = a.distance > b.options.tap_max_distance
        }
    }, d.gestures.Touch = {
        name: "touch",
        index: -1 / 0,
